#!/usr/bin/env python3
"""
Training script for BPE tokenizer on OpenWebText dataset.

This script trains a BPE tokenizer with vocab_size=32,000 on the OpenWebText dataset
...
def main():
    # Configuration
    input_path = "/ocean/projects/cis250265p/xli45/assignment1-basics/data/owt_train.txt"
    vocab_size = 32000
    special_tokens = ["<|endoftext|>"]
    output_dir = "/ocean/projects/cis250265p/xli45/assignment1-basics/trained_tokenizers/owt"
